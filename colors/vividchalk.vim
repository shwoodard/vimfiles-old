...
if &background == "light" || has("gui_running")
    hi Normal guibg=#1a1a1e ctermbg=Black
else
    hi Normal guibg=#1a1a1e ctermbg=NONE
endif

highlight StatusLine   guifg=#555555 guibg=#25252c gui=bold ctermfg=Black ctermbg=White cterm=bold
highlight StatusLineNC guifg=#555555 guibg=#25252c gui=none ctermfg=Black ctermbg=Grey  cterm=none
...
call s:hibg("LineNr"    ,"#1a1a1e","DarkBlue",80)
